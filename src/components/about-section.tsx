                      ...
                      <div className="tp-about-wapper3 mb-30" key={index}>
                        <div className="ab-main-img w-[500px] h-[500px]">
                          <Image
                            ...
                            src={`${process.env.NEXT_PUBLIC_API_URL}${(item?.multipleMedia?.[0] as any)?.formats?.medium?.url}`}
                            title="theme-pure"
                            width={500}
                            height={500}
                            alt="theme-pure"
                        ...
                        <div className="ab-sec-img w-[300px] h-[300px]">
                          <Image
                            // src={`${process.env.NEXT_PUBLIC_API_URL}${item?.multipleMedia?.[1]?.formats?.medium?.url}`}
                            src={`${process.env.NEXT_PUBLIC_API_URL}${(item?.multipleMedia?.[1] as any)?.formats?.medium?.url}`}
                            title="theme-pure"
                            width={300}
                            height={300}
                            alt="theme-pure"
