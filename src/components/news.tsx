                ...
                <div className="row text-center">
                    <div className="col-xl-12">
                        <div className="tp-section-box tp-section-box-2 p-relative mb-45"><span
                                className="tp-section-subtitle d-inline-block pre mb-10">news</span>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6">
                        <div className="tp-feed-item mb-30">
                            <div className="tp-feed-img p-relative">
                                <div className="fix"><a href="#"><img src="assets/img/blog/blog-big-1.jpg"
                                            alt="theme-pure" /></a></div>
                                <div className="tp-meta-date">
                                    <h3 className="meta-date-title"><a href="#">24</a></h3>
                                    <p>June</p>
                                </div>
                            </div>
                            <div className="tp-feed-content">
                                <div className="tp-latest-blog-meta"><span>by</span><a href="#">admin</a><a href="#">- cctv,
                                        security</a></div>
                                <h5 className="tp-latest-title"><a href="blog-details">Good name can make your company sound
                                        professional</a></h5>
